...
import { Smartphone, HardDrive, Cpu, ScreenShare, Wifi, Mic, Info, Loader2 } from 'lucide-react';
  ...
  const renderContent = () => {
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-base font-medium">GPU</CardTitle>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-base font-medium">Connectivity</CardTitle>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <CardTitle className="text-base font-medium">Media Devices</CardTitle>
