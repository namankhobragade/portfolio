...
export function ProposalGenerator() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            console.error(error);
            toast({
                description: "Oops! Something went wrong. Please try generating the proposal again. 🛠️",
                variant: "destructive",
            });
        } finally {
            setIsLoading(false);
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
            <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
                <div className="space-y-3">
                    <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight font-headline">AI Proposal Tool</h2>
                    <p className="mx-auto max-w-[800px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                        Need a professional freelance proposal? Fill out the form below to generate a personalized sales proposal for your project in seconds.
                    </p>
                </div>
